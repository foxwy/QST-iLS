...
# @Last Modified time: 2024-03-31 21:37:52
...
def exp_5(args):  # DFE_P_S
    args.na_state = "W"
    args.n_epochs = int(2 * 1e5)
    args.n_shots = 1
    args.n_meas = int(1e3)
    args.n_sample_one = 5

    args.method = "iLS"
    a = {10: 1, 15: 4, 20: 7, 25: 12}
    args.b = 0.1
    n_exp = 5
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_qubits", type=int, default=15,
                        help="number of qubits")
    parser.add_argument("--n_tols", type=int, default=int(1e5),
                        help="number of total measurement samples")
    parser.add_argument("--n_epochs", type=int,
                        default=int(2 * 1e5), help="number of epochs of SPSA")
    ...
    parser.add_argument("--method", type=str, default="iLS",
                        choices=["iLS", "DFE"], help="method of QST")
